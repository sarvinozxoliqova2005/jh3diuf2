...
//             <img src=""https://jsonplaceholder.typicode.com/photos${postId}""
//                  class="rounded-lg mb-3 w-full h-[220px] object-cover">

//             <div class="flex items-center gap-4 text-gray-800">
//                 <button class="comment-btn flex items-center gap-1"
//                         data-id="${post.id}">
...
//         openCommentPanel(comments);
//     }
// });



// function openCommentPanel(comments) {
...
//         const letter = c.email.charAt(0).toUpperCase();

//         return `
//         <div class="flex gap-3 p-3 border-b">
//             <div class="w-10 h-10 rounded-full bg-purple-500 text-white
...
//                 <p class="text-gray-500 text-sm">@${c.email.split('@')[0]}</p>
